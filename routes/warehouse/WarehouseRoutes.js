...
router.post('/', authenticateJWT, authorizeAdmin, validateBody(WarehouseDto), WarehouseController.create);
router.get('/', WarehouseController.getAll);
router.get('/:id', WarehouseController.getById);
router.put('/:id', authenticateJWT, authorizeAdmin,validateBody(WarehouseUpdateDto), WarehouseController.update);
